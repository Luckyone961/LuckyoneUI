...
local function BuildDamageMeterSection()
	...
	section.args.size.args.width = ACH:Range(L["Width"], nil, 2, { min = 100, max = 1200, step = 1 }, nil, nil, nil, function() return Private.Addon.db.profile.damageMeter.sizeMode ~= 'SHARED' end)
