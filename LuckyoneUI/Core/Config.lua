...
local function BuildSkinsSection()
	...
	section.args.addons.args.LeatrixPlus = ACH:Toggle('LeatrixPlus', nil, 6, nil, nil, nil, nil, nil, (Private.isRetail or Private.isMists) or not Private.IsAddOnLoaded('Leatrix_Plus'))
	return section
end
