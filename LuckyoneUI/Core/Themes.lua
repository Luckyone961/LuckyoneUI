...
function Private:Setup_Theme(theme, installer)
	...
	if theme == 'dark' then
		...
		-- Text colors
		E.db.unitframe.units.arena.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-classcolor]'
		E.db.unitframe.units.boss.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-classcolor]'
		E.db.unitframe.units.focus.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-classcolor]'
		E.db.unitframe.units.party.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or (profile == 1 and not Private.isClassic) and '[luckyone:name:short-classcolor]|r[ - >luckyone:healermana:percent]' or '[luckyone:name:short-classcolor]'
		E.db.unitframe.units.player.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-classcolor]'
		E.db.unitframe.units.raid1.name.text_format = Private.isMidnight and '' or '[luckyone:name:veryshort-classcolor]'
		E.db.unitframe.units.raid2.name.text_format = Private.isMidnight and '' or '[luckyone:name:veryshort-classcolor]'
		...
		E.db.unitframe.units.target.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-classcolor][ |r» >luckyone:target:last-classcolor]'
		E.db.unitframe.units.targettarget.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-classcolor]'
	...
	elseif theme == 'class' then
		...
		-- Text colors
		E.db.unitframe.units.arena.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-nocolor]'
		E.db.unitframe.units.boss.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-nocolor]'
		E.db.unitframe.units.focus.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-nocolor]'
		E.db.unitframe.units.party.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or (profile == 1 and not Private.isClassic) and '[luckyone:name:short-nocolor][ - >luckyone:healermana:percent]' or '[luckyone:name:short-nocolor]'
		E.db.unitframe.units.player.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-nocolor]'
		E.db.unitframe.units.raid1.name.text_format = Private.isMidnight and '' or '[luckyone:name:veryshort-nocolor]'
		E.db.unitframe.units.raid2.name.text_format = Private.isMidnight and '' or '[luckyone:name:veryshort-nocolor]'
		E.db.unitframe.units.raid3.name.text_format = Private.isMidnight and '' or '[luckyone:name:veryshort-nocolor]'
		E.db.unitframe.units.raidpet.name.text_format = Private.isMidnight and '' or '[luckyone:name:veryshort-nocolor]'
		E.db.unitframe.units.target.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-nocolor][ |r» >luckyone:target:last-classcolor]'
		E.db.unitframe.units.targettarget.customTexts.Luckyone_Name.text_format = Private.isMidnight and '' or '[luckyone:name:last-nocolor]'
