...
function Private:Setup_Theme(theme, installer)
	...
	if theme == 'dark' then
		...
		E.db.unitframe.units.party.customTexts.Luckyone_Name.text_format = (profile == 1 and not Private.isClassic) and '[luckyone:name:short-classcolor]|r[ - >luckyone:healermana:percent]' or '[luckyone:name:short-classcolor]'
	...
	elseif theme == 'class' then
		...
		E.db.unitframe.units.party.customTexts.Luckyone_Name.text_format = (profile == 1 and not Private.isClassic) and '[luckyone:name:short-nocolor][ - >luckyone:healermana:percent]' or '[luckyone:name:short-nocolor]'
