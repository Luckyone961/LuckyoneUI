...
function Private:Setup_Theme(theme, installer)
	...
	if theme == 'dark' then
		...
		E.db.unitframe.units.party.customTexts.Luckyone_Name.text_format = Private.isMidnight and '[luckyone:name-color]' or (profile == 1 and not Private.isClassic) and '[luckyone:name:short-classcolor]|r[ - >luckyone:healermana:percent]' or '[luckyone:name:short-classcolor]'
		...
		E.db.unitframe.units.raid2.name.text_format = Private.isMidnight and '[luckyone:name-color]' or '[luckyone:name:veryshort-classcolor]'
	...
	elseif theme == 'class' then
		...
		E.db.unitframe.units.party.customTexts.Luckyone_Name.text_format = Private.isMidnight and '[luckyone:name-nocolor]' or (profile == 1 and not Private.isClassic) and '[luckyone:name:short-nocolor][ - >luckyone:healermana:percent]' or '[luckyone:name:short-nocolor]'
		...
		E.db.unitframe.units.raid1.name.text_format = Private.isMidnight and '[luckyone:name-nocolor]' or '[luckyone:name:veryshort-nocolor]'
		E.db.unitframe.units.raid2.name.text_format = Private.isMidnight and '[luckyone:name-nocolor]' or '[luckyone:name:veryshort-nocolor]'
		E.db.unitframe.units.raid3.name.text_format = Private.isMidnight and '[luckyone:name-nocolor]' or '[luckyone:name:veryshort-nocolor]'
