...
function Private:Setup_ElvUI(layout)
	...
	E.db.movers.ArenaHeaderMover = (scaled and 'TOPRIGHT,ElvUIParent,TOPRIGHT,-340,-240') or 'TOPRIGHT,ElvUIParent,TOPRIGHT,-402,-280'
	...
	E.db.movers.BossHeaderMover = (scaled and 'TOPRIGHT,ElvUIParent,TOPRIGHT,-340,-240') or 'TOPRIGHT,ElvUIParent,TOPRIGHT,-402,-280'
	...
	E.db.movers.VehicleLeaveButton = (scaled and 'BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,450,413') or 'BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,831,552'
