...
L["Blizzard Edit Mode (1080p)"] = "Modo de Edição da Blizzard (1080p)"
L["Blizzard Edit Mode (1440p)"] = "Modo de Edição da Blizzard (1440p)"
...
L["Copy the import string from the Wago link and paste it in /wa."] = "Copie a string importada no link do Wago e cole em /wa."
...
L["Next"] = true
L["No ActionBars and centered Raid Frames"] = "Sem Barras de Ação e Paineis de Raíde centralizados"
L["No existing LuckyoneUI profile found."] = "Nenhum perfil LuckyoneUI encontrado."
...
L["Optional step. Skip if you plan on a fresh install."] = "Passo opcional. Pule se você planeja utilizar uma instalação nova."
L["Options"] = true
L["Orientation"] = true
...
L["This step will load your most recent LuckyoneUI profile."] = "Este passo irá carregar o seu perfil mais recente do LuckyoneUI."
...
L["Useful for a quick setup on your alts."] = "Util para uma configuração rápida em seus alts."
L["Vengeance"] = true
L["Vertical"] = true
L["Visibility"] = true
L["Warlock"] = "Bruxo"
