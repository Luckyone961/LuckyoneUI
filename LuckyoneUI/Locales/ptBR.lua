...
L["Choose between SkironCooldownManager, AyijeCDM and BetterCooldownManager."] = true
...
L["For position adjustments use /scm /acdm /bcdm X and Y offset options."] = true
L["Frost"] = true
L["Fury"] = true
