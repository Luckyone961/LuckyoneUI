...
L["Choose between SkironCooldownManager, AyijeCDM and BetterCooldownManager."] = "Wähle zwischen SkironCooldownManager, AyijeCDM und BetterCooldownManager."
...
L["For position adjustments use /scm /acdm /bcdm X and Y offset options."] = "Um die Positionen anzupassen, nutze /scm /acdm /bcdm X und Y offset Optionen."
L["Frost"] = true
L["Fury"] = true
