...
L["Displays the unit's name with classcolor and a maximum length of %s characters (Only works for friendly party/raid members)"] = "Zeigt den Namen der Einheit mit Klassenfarbe und einer maximalen Länge von %s Zeichen an (Funktioniert nur für befreundete Gruppen-/Raidmitglieder)"
...
L["Displays the unit's name with no color and a maximum length of %s characters (Only works for friendly party/raid members)"] = "Zeigt den Namen der Einheit ohne Farbe und mit einer maximalen Länge von %s Zeichen an (Funktioniert nur für befreundete Gruppen-/Raidmitglieder)"
