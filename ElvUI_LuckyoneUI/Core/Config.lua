...
function L1UI:Config()
	...
	L1UI.Options.args.tags.args.tag4 = ACH:Input(L["Displays the unit's level if the player is not max level"], nil, 6, nil, 'full', function() return '[luckyone:level]' end)
