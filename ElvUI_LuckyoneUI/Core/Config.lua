...
function L1UI:Config()
	...
	L1UI.Options.args.weakauras.args.keys = ACH:Execute(L["Link Keystones"], nil, 16, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/keystones') end)
	L1UI.Options.args.weakauras.args.trinket = ACH:Execute(L["Trinket Tracking"], nil, 17, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/Trinket') end)
	L1UI.Options.args.weakauras.args.affixes = ACH:Execute(L["Mythic+ Affixes"], nil, 18, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/affixes') end)
	L1UI.Options.args.weakauras.args.swapblaster = ACH:Execute(L["Swapblaster Alert"], nil, 19, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/swapblaster') end)
	L1UI.Options.args.weakauras.args.groupfinderClasses = ACH:Execute(L["Groupfinder Classes"], nil, 20, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/groupfinderClasses') end)
	L1UI.Options.args.weakauras.args.groupfinderApptext = ACH:Execute(L["Groupfinder Applicants"], nil, 21, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/appTextHide') end)
