...
function L1UI:Config()
	...
	L1UI.Options.args.weakauras.args.general.args.affixes = ACH:Execute('Mythic+ Affixes', nil, 2, function() Private:WeakAurasImport('affixes') end)
	L1UI.Options.args.weakauras.args.general.args.dragonriding = ACH:Execute('Dragonriding HUD', nil, 3, function() Private:WeakAurasImport('dragonriding') end)
	L1UI.Options.args.weakauras.args.misc = ACH:Group(L["WeakAuras - Misc"], nil, 4)
	L1UI.Options.args.weakauras.args.misc.inline = true
	L1UI.Options.args.weakauras.args.misc.args.trinket = ACH:Execute('Trinket Tracking', nil, 1, function() Private:WeakAurasImport('trinket') end)
	L1UI.Options.args.weakauras.args.misc.args.groupfinderClasses = ACH:Execute('Groupfinder Classes', nil, 2, function() Private:WeakAurasImport('groupfinderClasses') end)
	L1UI.Options.args.weakauras.args.misc.args.groupfinderApptext = ACH:Execute('Groupfinder Applicants', nil, 3, function() Private:WeakAurasImport('groupfinderApptext') end)
	L1UI.Options.args.weakauras.args.misc.args.handleFriendlyNP = ACH:Execute('Friendly NamePlates', nil, 4, function() Private:WeakAurasImport('handleFriendlyNP') end)
	L1UI.Options.args.weakauras.args.misc.args.handleNameplateFont = ACH:Execute('NamePlates Font', nil, 5, function() Private:WeakAurasImport('handleNameplateFont') end)
