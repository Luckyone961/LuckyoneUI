...
function L1UI:GetOptions()
	...
	L1UI.Options.args.profiles.args.header2 = ACH:Header(L["Healing Profiles"], 6)
	L1UI.Options.args.profiles.args.bossmodsHealing = ACH:Group(L["BossMods Profiles"], nil, 7)
