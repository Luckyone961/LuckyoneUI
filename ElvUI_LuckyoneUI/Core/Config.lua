...
function L1UI:Config()
	...
	L1UI.Options.args.weakauras.args.maintained.args.evoker = ACH:Execute(format('|cff33937F%s|r', L["Evoker"]), nil, 1, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/LuckyoneUI-Evoker') end)
	L1UI.Options.args.weakauras.args.maintained.args.druid = ACH:Execute(format('|cffFF7C0A%s|r', L["Druid"]), nil, 2, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/LuckyoneUI-Druid') end)
	...
	L1UI.Options.args.weakauras.args.general.args.keys = ACH:Execute('Link Keystones', nil, 1, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/keystones') end)
	L1UI.Options.args.weakauras.args.general.args.affixes = ACH:Execute('Mythic+ Affixes', nil, 2, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/affixes') end)
	L1UI.Options.args.weakauras.args.general.args.dragonriding = ACH:Execute('Dragonriding HUD', nil, 3, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/LuckyoneUI-Dragonriding') end)
	L1UI.Options.args.weakauras.args.misc = ACH:Group(L["WeakAuras - Misc"], nil, 4)
	L1UI.Options.args.weakauras.args.misc.inline = true
	L1UI.Options.args.weakauras.args.misc.args.trinket = ACH:Execute('Trinket Tracking', nil, 1, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/Trinket') end)
	L1UI.Options.args.weakauras.args.misc.args.groupfinderClasses = ACH:Execute('Groupfinder Classes', nil, 2, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/groupfinderClasses') end)
	L1UI.Options.args.weakauras.args.misc.args.groupfinderApptext = ACH:Execute('Groupfinder Applicants', nil, 3, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/appTextHide') end)
	L1UI.Options.args.weakauras.args.misc.args.handleFriendlyNP = ACH:Execute('Friendly NamePlates', nil, 4, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/handleFriendlyNamePlates') end)
	L1UI.Options.args.weakauras.args.misc.args.handleNameplateFont = ACH:Execute('NamePlates Font', nil, 5, function() E:StaticPopup_Show('L1UI_EDITBOX', nil, nil, 'https://wago.io/handleNamePlatesFont') end)
