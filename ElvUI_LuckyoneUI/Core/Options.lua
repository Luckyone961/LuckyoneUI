			...
			weakauras = {
				...
				args = {
					class1 = {
						...
						get = function() return 'https://wago.io/luckyoneDruid' end,
					},
					class2 = {
						order = 2,
						type = 'input',
						...
						get = function() return 'https://wago.io/luckyonePriest' end,
					},
					class3 = {
						order = 3,
						type = 'input',
						...
						get = function() return 'https://wago.io/luckyoneMonk' end,
					},
					class4 = {
						order = 4,
						type = 'input',
						...
						get = function() return 'https://wago.io/luckyoneWarlock' end,
					},
					class5 = {
						order = 5,
						type = 'input',
						...
						get = function() return 'https://wago.io/luckyoneHunter' end,
					},
					class6 = {
						order = 6,
						type = 'input',
						...
						get = function() return 'https://wago.io/luckyoneRogue' end,
					},
					class7 = {
						order = 7,
						type = 'input',
						...
						get = function() return 'https://wago.io/luckyoneMage' end,
					},
					class8 = {
						order = 8,
						type = 'input',
						width = 'normal',
						name = '|cffA330C9DH:|r',
						get = function() return 'https://wago.io/luckyoneDH' end,
					},
					class9 = {
						order = 9,
						type = 'input',
						width = 'normal',
						name = '|cffC41E3ADK:|r',
						get = function() return 'https://wago.io/luckyoneDK' end,
					},
					class10 = {
						order = 10,
						type = 'input',
						...
						get = function() return 'https://wago.io/luckyonePaladin' end,
					},
					class11 = {
						order = 11,
						type = 'input',
						...
						get = function() return 'https://wago.io/luckyoneShaman' end,
					},
					class12 = {
						order = 12,
						type = 'input',
						...
						get = function() return 'https://wago.io/luckyoneWarrior' end,
					},
				},
			},
			credits = {
