...
L1UI.InstallerData = {
	...
	Pages = {
		...
		[2] = function()
			...
			PluginInstallFrame.Option1:Show()
			PluginInstallFrame.Option1:SetScript('OnClick', function() Private:HandleAlts('Main') Private:Setup_PrivateDB() E:StaticPopup_Show('L1UI_RL') end)
			PluginInstallFrame.Option1:SetText(L["Alt: "] .. L["DPS & Tanks"])
			PluginInstallFrame.Option2:Show()
			PluginInstallFrame.Option2:SetScript('OnClick', function() Private:HandleAlts('Healing') Private:Setup_PrivateDB() E:StaticPopup_Show('L1UI_RL') end)
			PluginInstallFrame.Option2:SetText(L["Alt: "] .. L["Healing"])
			PluginInstallFrame.Option3:Show()
			PluginInstallFrame.Option3:SetScript('OnClick', function() Private:HandleAlts('Support') Private:Setup_PrivateDB() E:StaticPopup_Show('L1UI_RL') end)
