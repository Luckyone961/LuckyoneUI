...
L1UI.InstallerData = {
	...
	Pages = {
		...
		[2] = function()
			...
			PluginInstallFrame.Option1:Show()
			PluginInstallFrame.Option1:SetScript('OnClick', function() Private:HandleAlts('Main') Private:Setup_PrivateDB() end)
			PluginInstallFrame.Option1:SetText(format('|cff4beb2c%s', L["Alt: "] .. L["DPS & Tanks"]))
			PluginInstallFrame.Option2:Show()
			PluginInstallFrame.Option2:SetScript('OnClick', function() Private:HandleAlts('Healing') Private:Setup_PrivateDB() end)
			PluginInstallFrame.Option2:SetText(format('|cff4beb2c%s', L["Alt: "] .. L["Healing"]))
			PluginInstallFrame.Option3:Show()
			PluginInstallFrame.Option3:SetScript('OnClick', function() Private:HandleAlts('Support') Private:Setup_PrivateDB() end)
			PluginInstallFrame.Option3:SetText(format('|cff4beb2c%s', L["Alt: "] .. L["Support"]))
		end,
		[3] = function()
