		...
		PlaterDB["profiles"][Retail] = {
			...
			["script_data_trash"] = {
				...
				}, -- [8]
				{
					...
					["PlaterCore"] = 1,
					["url"] = "",
					["scriptId"] = "table: 000002B16616FE50",
					["UpdateCode"] = "function (self, unitId, unitFrame, envTable, scriptTable)\n    \nend\n\n\n",
					["Temp_Initialization"] = "function (scriptTable)\n    --insert code here\n    \nend",
				}, -- [9]
				{
