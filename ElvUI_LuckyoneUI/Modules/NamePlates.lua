...
function L1UI:SetupNamePlates(addon)
	...
	if addon == 'ElvUI' then
		...
		E.db["nameplates"]["units"]["ENEMY_NPC"]["buffs"]["countPosition"] = "RIGHT"
		E.db["nameplates"]["units"]["ENEMY_NPC"]["buffs"]["countXOffset"] = 13
		...
		E.db["nameplates"]["units"]["ENEMY_NPC"]["buffs"]["size"] = 21
		E.db["nameplates"]["units"]["ENEMY_NPC"]["buffs"]["spacing"] = 0
		E.db["nameplates"]["units"]["ENEMY_NPC"]["buffs"]["xOffset"] = 23
		E.db["nameplates"]["units"]["ENEMY_NPC"]["buffs"]["yOffset"] = -30
		...
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["buffs"]["countPosition"] = "RIGHT"
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["buffs"]["countXOffset"] = 13
		...
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["buffs"]["size"] = 21
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["buffs"]["spacing"] = 0
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["buffs"]["xOffset"] = 23
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["buffs"]["yOffset"] = -30
