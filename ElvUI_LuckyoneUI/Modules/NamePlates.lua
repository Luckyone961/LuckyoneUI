...
function L1UI:Setup_NamePlates(addon)
	...
	if addon == 'ElvUI' then
		...
		E.db.nameplates.units.ENEMY_NPC.level.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.ENEMY_NPC.power.text.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.ENEMY_NPC.title.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.ENEMY_PLAYER.level.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.ENEMY_PLAYER.power.text.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.ENEMY_PLAYER.title.font = L1UI.DefaultFont
		E.db.nameplates.units.ENEMY_PLAYER.title.format = '[npctitle]'

		-- Friendly NPC
		E.db.nameplates.units.FRIENDLY_NPC.buffs.countFont = L1UI.DefaultFont
		E.db.nameplates.units.FRIENDLY_NPC.buffs.countFontSize = 10
		E.db.nameplates.units.FRIENDLY_NPC.buffs.countPosition = 'TOP'
		E.db.nameplates.units.FRIENDLY_NPC.buffs.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_NPC.castbar.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_NPC.debuffs.countFont = L1UI.DefaultFont
		E.db.nameplates.units.FRIENDLY_NPC.debuffs.countFontSize = 10
		E.db.nameplates.units.FRIENDLY_NPC.debuffs.countPosition = 'TOP'
		E.db.nameplates.units.FRIENDLY_NPC.debuffs.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_NPC.health.text.font = L1UI.DefaultFont
		E.db.nameplates.units.FRIENDLY_NPC.health.text.format = '[luckyone:health:percent]'
		E.db.nameplates.units.FRIENDLY_NPC.level.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_NPC.power.text.font = L1UI.DefaultFont
		E.db.nameplates.units.FRIENDLY_NPC.pvpindicator.size = 35
		E.db.nameplates.units.FRIENDLY_NPC.questIcon.enable = false
		E.db.nameplates.units.FRIENDLY_NPC.questIcon.font = L1UI.DefaultFont
		...
		-- Friendly Player
		E.db.nameplates.units.FRIENDLY_PLAYER.buffs.countFont = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_PLAYER.buffs.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_PLAYER.castbar.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_PLAYER.debuffs.countFont = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_PLAYER.debuffs.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_PLAYER.health.text.font = L1UI.DefaultFont
		E.db.nameplates.units.FRIENDLY_PLAYER.health.text.format = '[luckyone:health:percent]'
		E.db.nameplates.units.FRIENDLY_PLAYER.level.font = L1UI.DefaultFont
		...
		E.db.nameplates.units.FRIENDLY_PLAYER.power.text.font = L1UI.DefaultFont
