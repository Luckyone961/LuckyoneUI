...
function L1UI:Setup_NamePlates(addon)
	...
	if addon == 'ElvUI' then
		...
		E.db.nameplates.plateSize.enemyWidth = 182
		E.db.nameplates.plateSize.friendlyHeight = 32
		E.db.nameplates.plateSize.friendlyWidth = 182
		E.db.nameplates.plateSize.personalHeight = 32
		E.db.nameplates.plateSize.personalWidth = 182
		...
		E.db.nameplates.units.ENEMY_NPC.buffs.size = 18
		E.db.nameplates.units.ENEMY_NPC.buffs.spacing = 0
		E.db.nameplates.units.ENEMY_NPC.buffs.xOffset = 20
		E.db.nameplates.units.ENEMY_NPC.buffs.yOffset = -26
		...
		E.db.nameplates.units.ENEMY_NPC.castbar.width = 169
		...
		E.db.nameplates.units.ENEMY_PLAYER.buffs.size = 18
		E.db.nameplates.units.ENEMY_PLAYER.buffs.spacing = 0
		E.db.nameplates.units.ENEMY_PLAYER.buffs.xOffset = 20
		E.db.nameplates.units.ENEMY_PLAYER.buffs.yOffset = -26
		...
		E.db.nameplates.units.ENEMY_PLAYER.castbar.width = 169
