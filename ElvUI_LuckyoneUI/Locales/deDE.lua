...
L["Credits"] = true
L["Current"] = "Aktuell"
L["Custom edits for:"] = true -- "for the following list of specs"
...
L["This will restart your Games Graphics Engine and is only required,\nif you've touched the CachelessShaderMode option above."] = "Dadurch wird Deine Games Graphics Engine neu gestartet und ist nur erforderlich,\nwenn Du oben die Option CachelessShaderMode berührt hast."
