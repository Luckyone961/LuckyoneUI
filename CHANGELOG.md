...
- Updated Aura Indicators (Preservation Evoker)  
...
**Retail:**  
- Initial default filters based on new patch 12.0.1 APIs (Will tweak further if needed)  
- Updated nameplate CVars to class color friendly name-only plates in instances  
...
- Ported my custom skins for various AddOn elements into my AddOn  
- DejaClassicStats  
- Leatrix Plus  
- LFG Bulletin Board  
